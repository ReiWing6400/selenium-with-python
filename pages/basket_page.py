...
class BasketPage(BasePage):
    def should_be_basket_url(self):
        assert "basket" in self.browser.current_url, "Basket text is not presented in current url"
        assert True
    ...
    def should_be_basket_empty_text(self):
        ...
        assert basket_empty_text == 'Your basket is empty', "Basket empty text is not presented"
        assert True
